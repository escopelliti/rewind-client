...
namespace ServerTest
{
    static class XMLFactory
    {
        ...
        public static XDocument CreateXMLDocument(int type, List<ProtocolUtils.FileStruct> filesList)
        {
        ...
        public static XDocument CreateXMLDocument(int type, object content)
        {
            XElement root = new XElement(ProtocolUtils.REQUEST);
            XDocument xmlDoc = new XDocument(root);
            root.Add(new XElement(ProtocolUtils.TYPE, type));
